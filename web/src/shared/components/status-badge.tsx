...
const MAP: Record<string, Tone> = {
  ...
  CALCULATED: { label: "Calculated", cls: "text-st-draft bg-st-draft-bg" },
  RECONCILED: { label: "Reconciled", cls: "text-st-review bg-st-review-bg" },
  REVISION: { label: "Revision requested", cls: "text-st-review bg-st-review-bg" },
  PENDING_SEND: { label: "Pending send", cls: "text-st-review bg-st-review-bg" },
