...
public class WorkflowOutboxRelay extends OutboxRelay {
    ...
    public WorkflowOutboxRelay(OutboxRepository outbox, OutboxRelayProperties props,
    ...
    protected void dispatch(OutboxEvent event) throws Exception {
        ...
        log.debug("Published workflow outbox {} type={} topic={}", event.getId(), event.getEventType(), event.topic());
    }
}
