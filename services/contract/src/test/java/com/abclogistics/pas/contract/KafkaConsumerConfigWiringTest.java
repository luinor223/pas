...
import com.abclogistics.pas.contract.config.KafkaConsumerConfig;
...
class KafkaConsumerConfigWiringTest {
    ...
    private final ApplicationContextRunner context = new ApplicationContextRunner()
            // a bare runner has no conversion service, so the @Value defaults (PT2S) would not
            // parse; a Boot application registers this for itself
